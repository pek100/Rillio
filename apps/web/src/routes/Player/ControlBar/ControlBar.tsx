...
const CB_ISLAND = 'flex flex-none flex-row items-center gap-2 glass rounded-full bg-glass-chrome p-1.5 backdrop-blur-(--glass-blur)';
        ...
        >
            ...
            <div className={'flex flex-row items-center gap-3 px-3 pb-2 max-sm:relative max-sm:gap-[0.15rem] max-sm:overflow-visible max-sm:px-2'}>
                ...
                <div className={cn(
                    ...
                    'flex flex-none flex-row gap-2 sm:glass sm:rounded-full sm:bg-glass-chrome sm:p-1.5 sm:backdrop-blur-(--glass-blur)',
