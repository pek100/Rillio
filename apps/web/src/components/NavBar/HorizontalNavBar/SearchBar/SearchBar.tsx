        ...
        >
            ...
            }
            {
                historyOpen && hasItems ?
                    <div className="panel-tint absolute left-0 top-full z-10 mt-2 w-full rounded-card border border-line bg-popover p-2 text-popover-foreground shadow-elevated">
                        <SearchSuggestions
