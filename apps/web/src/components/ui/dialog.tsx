            ...
            <DialogPortal>
                ...
                <DialogPrimitive.Content
                    ...
                    className={cn(
                        ...
                        // Dark glass panel wearing the shared .glass material (sheen +
                        // inset-highlight edge, no border). The blur comes from the
                        // overlay, so NO backdrop-blur here (one blur per stacking
                        // context).
                        'glass bg-card text-card-foreground rounded-squircle p-6',
